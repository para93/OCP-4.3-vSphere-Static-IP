...
cluster_domain = "demo.lzed.com"

// Base domain from which the cluster domain is a subdomain.
base_domain = "lzed.com"

// Name of the vSphere server. The dev cluster is on "vcsa.vmware.devcluster.openshift.com".
vsphere_server = "drtacvcenter01.lzed.com"
...
vsphere_cluster = "DRTACDATACENTER"

// Name of the vSphere data center. The dev cluster is "dc1".
vsphere_datacenter = "DRTACXL"

// Name of the vSphere data store to use for the VMs. The dev cluster uses "nvme-ds1".
vsphere_datastore = "freenas02"
...
bootstrap_ignition_url = "http://192.168.20.8:8080/ignition/bootstrap.ign"
...
bootstrap_ip = "192.168.20.118"

// The IP addresses to assign to the control plane VMs. The length of this list
// must match the value of control_plane_count.
control_plane_ips = ["192.168.20.113", "192.168.20.114", "192.168.20.115"]

// The IP addresses to assign to the compute VMs. The length of this list must
// match the value of compute_count.
compute_ips = ["192.168.20.116", "192.168.20.117", "192.168.20.119", "192.168.20.120"]
